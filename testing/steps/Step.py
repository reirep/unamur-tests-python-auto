from testing.steps.exceptions.IllegalAction import IllegalAction
from testing.steps.exceptions.IncompatibleRequestForConfig import IncompatibleRequestForConfig
